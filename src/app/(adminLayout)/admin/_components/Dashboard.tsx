  ...
  return (
    <div className="">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        <div className="bg-slate-700 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 flex items-center">
      ...
      {/* Data table */}
      <div className="mt-16">{/* <BookingTable/> */}</div>
    </div>
  );
};
